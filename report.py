...
for thisDate in dateLs:
    ...
    orderLog['colo_broker'] = orderLog['colo'] + '_' + orderLog['broker'].astype('str')
    ...
    readPath = r'\\192.168.10.30\Kevin_zhenyu\orderLog\mdData'
    ...
    infoData.groupby(['date', 'secid', 'vai', 'Price', 'OrderQty', 'Side', 'statusLs', 'TradePriceLs', 'TradeQtyLs'])[
        'colo_broker'].transform('count')
    infoData['brokerLs'] = infoData['brokerLs'] = \
    infoData.groupby(['date', 'secid', 'vai', 'Price', 'OrderQty', 'Side', 'statusLs', 'TradePriceLs', 'TradeQtyLs'])[
        'colo_broker'].transform(lambda x: ','.join(sorted(x.unique())))
    ...
    infoData = infoData[
        ['date', 'secid', 'vai', 'group', 'Price', 'OrderQty', 'Side', 'statusLs', 'TradePriceLs', 'TradeQtyLs',
    ...
    savePath = r'\\192.168.10.30\Kevin_zhenyu\orderLog\result\marketPos'
